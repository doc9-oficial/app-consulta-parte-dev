...
interface ConsultarParteParams {
  termo: string;
  filtro?: string;
}

async function consultarParte(params: ConsultarParteParams): Promise<void> {
  try {
    ...
    console.log(`Executando consultarParte com termo=${params.termo}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Busca processos por nome da parte concluído com sucesso",
      resultado: {
