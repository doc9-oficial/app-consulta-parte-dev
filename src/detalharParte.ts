...
interface DetalharParteParams {
  parametro: string;
  filtro?: string;
}

async function detalharParte(params: DetalharParteParams): Promise<void> {
  try {
    ...
    console.log(`Executando detalharParte com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Obtém detalhes de parte em processo concluído com sucesso",
      resultado: {
